...
public class PathogeneAgressif extends Pathogene {
      ...
      public PathogeneAgressif(float chargePathogene, String nom, Map<String, Float> resistancesMedicament, float sensibiliteSystemeImmunitaire, float sensibiliteMedicament, float tauxReplication, Patient patient) {
    ...
    // Pareil que le pathogène classique, mais avec croissance "quadratique" (Lt²)
    @Override 
    public void evoluer() {
